<div class="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5">
    <div class="px-6 flex items-center justify-between space-x-4 2xl:container">
        ...
        @elseif (Route::currentRouteName() == 'incomes.index')
            <h5 hidden class="text-2xl text-gray-600 font-medium lg:block">Incomes</h5>
        @elseif (Route::currentRouteName() == 'expense.index')
            <h5 hidden class="text-2xl text-gray-600 font-medium lg:block">Expenses</h5>
        @elseif (Route::currentRouteName() == 'summary')
            <h5 hidden class="text-2xl text-gray-600 font-medium lg:block">Reports</h5>
            @elseif (Route::currentRouteName() == 'setting')
            <h5 hidden class="text-2xl text-gray-600 font-medium lg:block">Settings</h5>
        @elseif (Route::currentRouteName() == 'notes.index')
            <h5 hidden class="text-2xl text-gray-600 font-medium lg:block">Notes</h5>
        @endif
