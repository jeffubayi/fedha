<x-layout>
    <a href="/" class="inline-block  ml-4 mb-4 text-gray-400 "><i class="fa-solid fa-arrow-left text-gray-400 "></i>
    </a>
    <div class="mx-20 grid mt-5">
        ...
        <div class="flex flex-row rounded-lg border border-gray-200/80 bg-white p-6">
            ...
            <div class="relative">
                ...
                <img class="w-40 h-40 rounded-md object-cover"
                    src="{{ $list->logo ? asset('storage/' . $list->logo) : asset('storage/logos/no-image.png') }}"
                    alt="User" />
            ...
            <div class="flex flex-col px-6">
                ...
                <div class="my-2 flex flex-row space-x-2">
                    ...
                    <div class="flex flex-row">
                        ...
                        <div class="text-xs text-gray-400/80 hover:text-gray-400">{{ $list->company }}</div>
                    </div>
                    ...
                    <div class="flex flex-row">
                        ...
                        <div class="text-xs text-gray-400/80 hover:text-gray-400">{{ $list->location }}</div>
                    </div>
                    ...
                    <div class="flex flex-row">
                        ...
                        <div class="text-xs text-gray-400/80 hover:text-gray-400">{{ $list->email }}</div>
                    </div>
                </div>
                ...
                <div class="mt-2 flex flex-row items-center space-x-5">
                    ...
                    <a href="#"
                        ...
                        <div class="flex flex-row items-center justify-center">
                            ...
                            <span class="font-bold text-gray-600"> site </span>
                        </div>

                        <div class="mt-2 text-sm text-gray-400">{{ $list->website }}</div>
                    </a>
                    ...
                    <a href="#"
                        ...
                        <div class="flex flex-row items-center justify-center">
                            ...
                            <span class="font-bold text-gray-600"> Grade </span>
                        </div>

                        <div class="mt-2 text-sm text-gray-400">{{ $list->company }}</div>
                    </a>
                    ...
                    <a href="#"
                        ...
                        <div class="flex flex-row items-center justify-center">
                            ...
                            <span class="font-bold text-gray-600"> about </span>
                        </div>

                        <div class="mt-2 text-sm text-gray-400">{{ $list->description }}</div>
                    </a>
                </div>
            </div>
