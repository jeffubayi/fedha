          ...
          <div class="flex flex-col px-6">
            ...
            <div class="my-2 flex flex-row space-x-2">
              ...
              {{-- <div class="flex flex-row">
                ...
                <div class="text-xs text-gray-400/80 hover:text-gray-400">{{ auth()->user()->company }}</div>
              </div>
              ...
              <div class="flex flex-row">
                ...
                <div class="text-xs text-gray-400/80 hover:text-gray-400">{{ auth()->user()->location }}</div>
              </div> --}}
