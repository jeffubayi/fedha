        ...
        <div
            ...
            <div class="bg-white p-3 rounded-xl shadow-xl flex items-center justify-between mt-4">
                <div class="flex space-x-6 items-center">
                    <img src="https://www.nicepng.com/png/full/32-326591_banner-library-college-vector-graduated-student-male-student.png"
                        class="w-auto h-12" />
                    <div>
            ...
            <div class="bg-white p-3 rounded-xl shadow-xl flex items-center justify-between mt-4">
                <div class="flex space-x-6 items-center">
                    <img src="https://www.nicepng.com/png/full/294-2948447_b-teachers-teacher-clip-art-teacher-cartoon.png"
                        class="w-auto h-12" />
                    <div>
                        <p class="font-semibold text-base">35</p>
                        <p class="font-semibold text-xs text-gray-400">Total Staff</p>
                    </div>
                </div>
            ...
            <div class="bg-white p-3 rounded-xl shadow-xl flex items-center justify-between mt-4">
                <div class="flex space-x-6 items-center">
                    <img src="https://www.nicepng.com/png/full/10-101646_borrow-library-books-book-stack-books-icon.png"
                        class="w-auto h-12" />
                    <div>
                        <p class="font-semibold text-base">19</p>
                        <p class="font-semibold text-xs text-gray-400">Total Subjects</p>
                    </div>
                </div>
            ...
            <div class="bg-white p-3 rounded-xl shadow-xl flex items-center justify-between mt-4">
                <div class="flex space-x-6 items-center">
                    <img src="https://www.nicepng.com/png/full/263-2636046_administrator-icon-data-administrator-icon.png"
                        class="w-auto h-12" />
                    <div>
                        <p class="font-semibold text-base">10</p>
                        <p class="font-semibold text-xs text-gray-400">Total Admins</p>
                    </div>
                </div>
        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div class="md:col-span-2 lg:col-span-1">
                ...
                <div
                    ...
                    <div class="flex justify-between items-center mb-4">
                        <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-gray-700">Latest Students
                        </h5>
            ...
            <div>
                <div class="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
                    <h5 class="text-xl text-gray-700">Student attendance</h5>
                    <div class="my-8">
                ...
                <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-4 xxl:col-span-4 px-4 ">
                    ...
                    <div class="p-4 max-w-sm bg-white rounded-lg border shadow-md sm:p-6 ">
                        ...
                        <ul class="my-4 space-y-3">
                            <li>
                                <a href="#"
                                    class="flex items-center p-3 text-base font-bold text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-100 group hover:shadow  ">
                            ...
                            <li>
                                <a href="#"
                                    class="flex items-center p-3 text-base font-bold text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-150 group hover:shadow ">
                                    <svg svg="" class="h-5" viewBox="0 0 75.591 75.591"
                    ...
                    <div class="bg-white p-3 rounded-xl shadow-xl flex items-center justify-between mt-4">
                        <div class="flex space-x-6 items-center">
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-sm text-gray-400">Authorize devices</p>
                            </div>
                        </div>
