...
<body class="mb-4 bg-gray-100">
    ...
    <x-card class="p-10 max-w-lg mx-auto mt-24">
        <form action="/users" method="POST">
            ...
            <button
                class="text-white bg-gradient-to-r from-sky-600 to-cyan-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register
                new account</button>
            <div class="flex items-start mt-2">
                <label for="terms" class="ml-2 text-sm font-medium text-gray-900 ">Already have an account?<a
                        href="/login" class="text-cyan-400 hover:underline dark:text-blue-500 m-2">Login</a></label>
