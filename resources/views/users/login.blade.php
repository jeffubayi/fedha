    ...
    <div class="h-screen flex">
        <div class="hidden lg:flex w-full lg:w-1/2 login_img_section
            ...
            <div class="w-full mx-auto px-20 flex-col items-center space-y-6">
                ...
                <p class="text-white mt-1">Your personal finance manager</p>
                <div class="flex justify-center lg:justify-start mt-6">
                    <a href="#"
                        class="hover:bg-blue-600 hover:text-white hover:-translate-y-1 transition-all duration-500 bg-white text-indigo-800 mt-4 px-4 py-2 rounded-2xl font-bold mb-2">Get
                        Started</a>
                </div>
            </div>
        </div>
                ...
                <form class="space-y-6" action="/users" method="POST">
                    ...
                    <div class="flex items-start">
                        <div class="flex items-start">
                            ...
                            <label for="remember" class="ml-2 text-sm font-medium text--blue-600  ">Remember me</label>
                        </div>
