...
@section('content')
    <div class="mx-20 grid mt-5">
        ...
        <div class="flex flex-row rounded-lg border border-gray-200/80 bg-white p-6">
            ...
            <div class="relative">
                <!-- User Avatar -->
                <img class="w-40 h-40 rounded-md object-cover" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgSmojUgwjIB87c4Q0hLCAyl__oiTySWGWJUZtUNHlHjBALLzTsu_vMHYMaEwLts4QEoo&usqp=CAU"
                    alt="User" />
            ...
            <div class="flex flex-col px-6">
                ...
                <div class="mt-2 flex flex-row items-center space-x-5">
                    ...
                    <a href="/notes"
                        ...
                        <div class="mt-2 text-sm text-gray-400">Notes</div>
                    </a>
                    ...
                    <a href="/expense"
                        ...
                        <div class="flex flex-row items-center justify-center">
                            ...
                            <span class="font-bold text-gray-600"> {{ $expenses}} </span>
                        </div>

                        <div class="mt-2 text-sm text-gray-400">Expense</div>
                    </a>
                    ...
                    <a href="/incomes"
                        ...
                        <div class="flex flex-row items-center justify-center">
                            ...
                            <span class="font-bold text-gray-600"> {{$incomes }} </span>
                        </div>

                        <div class="mt-2 text-sm text-gray-400">Income</div>
                    </a>
                </div>
            </div>
