        ...
        <div class="max-w-2xl mx-auto bg-white rounded-lg  p-16">
            ...
            <form method="POST" action="{{ route('notes.store') }}" enctype="multipart/form-data">
                ...
                <div class="grid gap-6 mb-6 lg:grid-cols-2">
                    <div>
                        <label for="notes_title" class="block mb-2 text-sm font-medium text-gray-900 ">
                            Amount</label>
                        <input type="text" name="note_amount" id="company"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                        @error('note_amount')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        <label for="title" class="block mb-2 text-sm font-medium text-gray-900 ">
                            Date</label>
                        <input type="text" name="note_date" value="{{ date('Y-m-d') }}" id="title"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                        @error('note_date')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
